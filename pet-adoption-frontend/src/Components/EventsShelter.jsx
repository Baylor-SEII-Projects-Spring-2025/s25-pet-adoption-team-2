...
// Master list of all possible events
const masterEvents = [
  {
  ...
  },
  {
    ...
    imageUrl:
      "https://paintyourpetsportrait.com/wp-content/uploads/2022/01/Facebook-Banner-single-pets-Small.png"
  },
  {
    ...
    imageUrl:
      "https://i.etsystatic.com/25964056/r/il/dfb12d/3749125979/il_570xN.3749125979_p33o.jpg"
  },
  {
    ...
    imageUrl:
      "https://d17fnq9dkz9hgj.cloudfront.net/uploads/2017/10/PF2015_017_Rue_FrontYard-640.jpg"
  },
  {
    ...
    imageUrl:
      "https://mms.businesswire.com/media/20160901006586/en/542449/5/pet_dog_20160726_PetSmart-Scrimmage_0391-min.jpg"
  },
  {
    ...
    imageUrl:
      "https://images.squarespace-cdn.com/content/v1/59d79627f7e0ab7585717499/1588104563731-R7LE2NDG2B9APQ93UGF5/PHOTO-2020-04-12-17-09-05.jpg"
  },
  {
  ...
  },
  {
    ...
    imageUrl:
      "https://offloadmedia.feverup.com/secretldn.com/wp-content/uploads/2021/04/21045503/doggy-drive-in-film-club-1024x683.png"
  },
  {
    ...
    imageUrl:
      "https://www.thesprucepets.com/thmb/6eGfO7YKsdRUO-lwV8bPgZhaNjo=/1500x0/filters:no_upscale():strip_icc()/10_fun_and_easy_dog_tricks_11173309_beg_2796-c8293aefe01b456b8aa1290bb1af7423.jpg"
  }
];
...
const EventsShelter = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (conflict) {
        setErrorMsg(
          "An event is already scheduled at the same date, time, and location."
        );
        setSuccessMsg("");
        return;
      }
